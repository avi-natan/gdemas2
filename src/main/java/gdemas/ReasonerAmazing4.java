...
public class ReasonerAmazing4 extends Reasoner {
    ...
    public ReasonerAmazing4(String   benchmarkName,
                            String   domainName,
                            String   problemName,
                            File     domainFile,
                            File     problemFile,
...
//        print(java.time.LocalTime.now() + ": " + "combining...");
        ...
        print(java.time.LocalTime.now() + ": amazing4 - success. Diagnoses num: " + this._DIAGNOSES_NUM + ", Combine time in MS: " + this._COMBINING_RUNTIME + ", Total time in MS: " + this._TOTAL_RUNTIME);
